...
export default function LoginPage() {
  return (
    <div className="min-h-screen relative flex items-center justify-center font-cairo overflow-hidden" dir="rtl">
      ...
      <div className="relative z-10 w-full max-w-[1200px] flex flex-col items-center py-12 px-6">
        ...
        <div className="mb-8 flex flex-col items-center">
            <div className="relative flex items-end">
              ...
              <span className="absolute top-1 right-17.5 w-3.5 h-3.5 bg-brand-gold rounded-sm rotate-45 border-2 border-[#171D5B]"></span>
            </div>
        ...
        <div className="w-full max-w-[500px] bg-white rounded-md p-10 md:p-12 shadow-2xl">
          <h1 className="text-3xl font-black text-brand-blue text-center mb-10">تسجيل الدخول</h1>
              ...
              <Form className="space-y-8">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex justify-start mt-1">
                    <Link href="/forgot-password" className="text-blue-500 text-xs font-bold hover:text-blue-800 hover:underline transition-colors">
                       نسيت كلمة المرور
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex flex-row-reverse gap-4 pt-4" dir="ltr">
                  ...
                  >
                    <span className="relative z-10">تسجيل حساب من خلال إنفاذ</span>
      ...
      {/* Floating Decorative Elements (Optional for extra premium feel) */}
